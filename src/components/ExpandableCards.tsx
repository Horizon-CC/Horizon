  ...
  return (
    <>
              ...
              <div className="min-h-[300px] max-h-[300px] overflow-y-auto">
                ...
                <div className="pt-2 relative px-4">
                  <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="text-neutral-600 text-xs md:text-sm lg:text-base flex flex-col items-start gap-4 overflow-auto dark:text-neutral-400 font-body h-32 md:h-40 pb-6 md:pb-10"
                  >
      ...
      <div className="relative w-screen h-[95vh] overflow-hidden">
        ...
        <ul className="relative grid grid-cols-2 md:grid-cols-5 gap-5 overflow-y-auto w-full h-full items-start bg-transparent p-10">
          {cards.map((card) => (
            <motion.div
              ...
              className="flex flex-col border-2 border-transparent rounded-lg cursor-pointer shadow-sm bg-white dark:bg-neutral-500 min-h-[250px] max-h-[250px] md:min-h-[350px] md:max-h-[350px] overflow-hidden"
            >
              <div className="flex flex-col rounded-lg">
                <motion.div layoutId={`image-${card.id}-${id}`}>
                  <img
                    src={card.src}
                    alt={card.title}
                    className="h-full w-full rounded-t-lg object-fit object-top"
                  />
                </motion.div>

                <div className="flex flex-col items-center text-center py-3 gap-2 over">
                  <motion.h3
