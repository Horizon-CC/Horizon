...
export default function LeadMembers() {
  ...
  return (
    <main className="h-[70vh] w-screen flex flex-col min-h-[75vh] md:min-h-[70vh]">
      {/* ================= MOBILE ================= */}
      <div className="lg:hidden flex flex-col h-full">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {/* Mobile Badges  */}
            <div className="px-4 border-t-2 pb-4 flex-shrink-0">
              <div className="flex flex-wrap gap-2 justify-center max-h-20 overflow-hidden my-2">
                <AnimatePresence>
      ...
      <div className="hidden lg:grid grid-cols-3 gap-4 h-full">
        ...
        {/* Desktop Info Area */}
        <div className="col-span-1 border-l-2 flex flex-col justify-start">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              exit="exit"
              variants={infoVariants}
              className="flex flex-col px-4 h-3/4"
            >
              <div
                className={`py-4 font-heading font-extrabold min-h-[15%] text-6xl text-end ${activeColor?.heading} dark:${activeColor?.headingDark}`}
              >
                {content[activeTab].title}
              </div>
              <div className="font-body min-h-[60%] text-md leading-relaxed text-end">
            ...
            <div className="border-t-2 p-4">
              <div className="h-fit flex flex-wrap gap-2 justify-end max-h-24 overflow-hidden">
                <AnimatePresence>
