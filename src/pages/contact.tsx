      ...
      <section className="w-full min-h-[25vh]">
        ...
        <div className="hidden md:grid grid-cols-12">
          ...
          <div className="col-span-6 flex flex-col justify-center px-6 py-8 gap-y-4">
            <h2 className="text-2xl font-extrabold font-heading">We’re Horizon</h2>
            <p className="font-body">
              A community of curious builders learning how the cloud really
              works. From AWS and Azure to whatever’s next, we focus on hands-on learning,
              real projects, and skills that actually matter.
              <br />
              Whether you’re just getting started or already building, Horizon is the place
              to learn, ship, and grow together.
              <span className="text-purple-600 dark:text-purple-400 font-semibold">
                {" "}Get in touch and build with us.
              </span>
            </p>
          </div>
            ...
            >
              ...
              >
                <File
                  value="github"
                  onClick={() =>
                    handleClick("https://github.com/Horizon-CC")
                  }
                  fileIcon={
                ...
                <File
                  value="linkedin"
                  onClick={() =>
                    handleClick("https://www.linkedin.com/company/horizoncc/")
                  }
                  fileIcon={
                ...
                <File
                  value="email"
                  onClick={() =>
                    handleClick("mailto:horizon@citchennai.net")
                  }
                  fileIcon={
        ...
        <div className="md:hidden flex flex-col w-[100vw] py-4 px-10 gap-y-4">
          ...
          <div className="flex flex-row ">
            <div className="w-full flex flex-col mr-4">
              <h2 className="text-lg font-extrabold font-heading">We’re Horizon </h2>
